 ...
 * Contiene validaciones internas en setters para consistencia.
 */
public class Cliente {
    ...
    private String codigo_postal;     // Obligatorio 5 dígitos
    ...
    public void setSegundo_apellido(String segundo_apellido) {
        if (segundo_apellido == null || segundo_apellido.isBlank()) {
            this.segundo_apellido = null; // Permitir vacío
        } else {
