...
/**
 * Clase que representa un alquiler de vivienda. Contiene todos los atributos de
 * la tabla alquileres de la BBDD. Incluye validaciones internas para garantizar
 * consistencia.
 */
public class Alquiler {
    ...
    public BigDecimal getPrecio_total_estimado() {
        return precio_total_estimado;
    }
    ...
    public int getId_estado_cobro() {
        return id_estado_cobro;
    }
    ...
    public void setVivienda(Vivienda vivienda) {
        ...
        if (vivienda != null) {
            this.id_vivienda = vivienda.getId_vivienda();
        }
    }
    ...
    // toString
    // -------------------------------
    // Método específico para mostrar en JComboBox
